...
import type { Idea as _Idea } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getRandomIdea(arg0: string, arg1: string, arg2: bigint): Promise<Idea | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getRandomIdea(arg0, arg1, arg2);
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Idea]): Idea | null {
